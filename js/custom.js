...
/*			markers: [{ latitude: 45.256,
			...
			center: new google.maps.LatLng(-31.165174, -64.327131),
			zoom: 15,
		...
		var marker = new google.maps.Marker({
			position: new google.maps.LatLng(-31.165174, -64.327131),
			map: map,
			icon: image
		});
	}
...
/* ==== 17) Instagram feed ==== */
	...
	if ( $instagramfeed.length){
		$('.instagram-lite').instagramLite({
			...
			// username: 'awerest',
			clientID: '906f31ebc2a04ceebf34ff6544c32101',
			username: 'chanechocolates',
			limit: '4'
		});
	}
